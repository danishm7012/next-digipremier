        ...
        <Container>
          ...
          <Navbar.Collapse id='responsive-navbar-nav'>
            <Nav className='ml-auto text-center'>
              ...
              >
                <NavDropdown.Item>
                  <Link href='/training-video'>Training Videos </Link>
                </NavDropdown.Item>

                <NavDropdown.Item>
                  <Link href='/product-video'>Products Videos</Link>
                </NavDropdown.Item>
                <NavDropdown.Item>
                  <Link href='/fashion-video-ads'>Fashion And Textile Ads</Link>
                </NavDropdown.Item>
                <NavDropdown.Item>
                  <Link href='/short-film-production'>Short Movies</Link>
                </NavDropdown.Item>
                <NavDropdown.Item>
                  <Link href='/model-portfolio-service'>Model Portfolios</Link>
                </NavDropdown.Item>
                <NavDropdown.Item>
                  <Link href='/commercial-shoot-studio'>Commercial Shots</Link>
                </NavDropdown.Item>
                <NavDropdown.Item>
                  <Link href='/green-screen-video-editor'>
                    Green Screen Videos
                  </Link>
                </NavDropdown.Item>
                <NavDropdown.Item>
                  <Link href='/2d-animation-expert-service'>2D Animations</Link>
                </NavDropdown.Item>
                <NavDropdown.Item>
                  <Link href='/corporate-profile-video'>
              ...
              <Nav.Link href='/contact' className='links-nav'>
                Contact
              </Nav.Link>
